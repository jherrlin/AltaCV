...
\personalinfo{%
  ...
  \mailaddress{Södra Åreda Källehult, 35575 Åryd.}
...
\cvevent{ System Architect / Software Developer }{Fortnox AB}{Aug 2021 -- Ongoing}{Växjö (hybrid), Sweden}

Part of two teams. Architect team with a focus on technical progression and
maintenance for the organization. Other team has a focus on internal developer
tools.
...
Implementing and maintaining features for end users in a bookkeeping web application.
...
\cvevent{Software Developer / Project Manager}{Herrlin Software}{May 2020 -- Ongoing}{Växjö, Sweden}

Sole proprietorship where I can leverage the Clojure ecosystem to create
production systems.
...
Web based system for planning and organizing ground and construction
work. \\
...
Web based system for managing and ordering spare parts for washing machines.
...
Book circle with focus on IT related books. The group meets every week to discuss
read pages.
...
Student union with a IT focus. Social events with companies in a combination
...
\wheelchart{1.5cm}{0.5cm}{%
  6/8em/accent!20/Eating parentheses,
  3/8em/accent!20/Reading,
  8/8em/accent!60/Daytime job,
  2/10em/accent/Climbing,
...
\begin{quote}
``Solving problems together makes us all better.''
\end{quote}
...
\cvachievement{\faHeartbeat}{Meetup organizer}{Functional programming focused meetup}

\divider

\cvachievement{\faHeartbeat}{Student union founder}{Kodkollektivet, for IT students at LNU}
...
\cvevent{Bachelor degree, Computer Science}{Linnaeus University}{Sept 2014 -- June 2017}{}
